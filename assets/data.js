...
// Struktur ini menggabungkan semua informasi rilis ke dalam satu array
...
const releasesData = [
    {
        ...
        content: `
            ...
            <p>Organisasi Kemasyarakatan Pemuda (OKP) yang tergabung dalam Cipayung Plus Provinsi NTB yakni, PKC PMII Bali Nusra, BADKO HMI Bali Nusra, DPD GMNI NTB, PW KAMMI NTB, PD KMHDI NTB, EW LMND NTB, DPD IMM NTB.</p>
            <p>Ketua Umum BADKO HMI Bali Nusra Caca Handika mengatakan kehadiran Cipayung Plus NTB melakukan konferensi pers menuntut terkait dengan penahanan 6 aktivis Cipayung Plus Bima yang melakukan aksi demonstrasi damai di Bandar Sultan Muhammad Salahuddin Bima, pada tanggal 28, Mei 2025 hari lalu hingga sampai sekarang masih di tahan di Polda NTB.</p>
            <p>"Kami kecewa dengan sikap Kapolda NTB tidak memberikan kesempatan untuk kami melakukan konferensi di dalam area Polda NTB," ujar Caca Handika.</p>
            <p>Lebih lanjut Caca Handika, kami menilai AKBP Eko Sutomo, S.I.K.,M.I.K Kapolres Kabupaten Bima melakukan manuver untuk menghambat upaya proses mediasi ditingkat penyelidikan secara non litigasi dengan menetapkan mereka sebagai tersangka melalui konferensi pers pada tanggal 31, Mei 2025.</p>
            <p>Semestinya Kapolres harus berkoordinasi dengan Pemerintah Kabupaten Bima sebagai pihak terlapor, sebelum menetapkan tersangka, karena keterangan pihak yang dirugikan perlu di dengar, apakah kasus ini perlu dilanjutkan atau tidak.</p>
            <p>"Dilihat dari kedudukan hukum, perbuatan mereka masuk kategori tindak pidana ringan, jadi langkah penyelesaian cukup melalui proses Restorative Justice, tanpa harus diproses lebih lanjut, dan diperbesarkan," tutur Ketua BADKO HMI.</p>
            <p>PKC PMII Bali Nusra Ahmad Muzakkir menegaskan, Cipayung Plus NTB menilai Kapolres Kabupaten Bima AKBP Eko Sutomo, sengaja menghambat upaya proses perdamaian dalam kasus yang menjerat keenam mahasiswa tersebut. Kasus ini semestinya dapat diselesaikan melalui pendekatan hukum yang berkeadilan dan manusiawi, yakni melalui mekanisme restorative justice, sesuai dengan prinsip-prinsip hukum progresif dan semangat pembinaan terhadap generasi muda bangsa.</p>
            <p>"Ketika pernyataan sikap ini tidak diindahkan oleh Kapolda NTB maka kami pastikan Cipayung Plus NTB akan kembali dengan ribuan massa dalam waktu dekat ini," tegas Ketua PKC PMII.</p>
            <p>Tak hanya itu, Ketua DPD IMM NTB Mahmud menyesalkan sikap Kapolres Bima telah menujukan gestur arogansi dalam penetapan tersangka yang sangat tergesah-tergesah tanpa memberikan ruang para pihak untuk berdialog dan perlindungan hukum dalam proses pemeriksaan perkara quo, dan lebih konyolnya lagi sehari setelah Pemberitahuan Perlengkapan Berkas Perkara (P21), para tahanan tersebut di kirim ke Kapolda NTB, tanpa alasan yang jelas.</p>
            <p>Sementara locus tempus delicti penyelidikan di wilayah Polres Kabupaten Bima. Atas sikapnya Kapolres Bima, AKBP Eko Sutomo sengaja menghalangi upaya restorative justice agar tidak terjadi resolusi damai antara kedua belak pihak.</p>
            <p>"Kuat dugaan bahwa adanya penghambatan proses restorative justice oleh Kapolres Bima," sesal Mahmud.</p>
            <p>Kata dia, Tindakan ini kami anggap sebagai bentuk arogansi kekuasaan yang tidak sejalan dengan nilai-nilai keadilan, demokrasi, serta perlindungan terhadap kebebasan sipil, dan juga memperkeruh hubungan antara warga sipil, dan aparat. Perbuatan ini dipandang sebagai bentuk kriminalisasi terhadap ekspresi demokratis yang memperjuang aspirasi rakyat.</p>
            <p>"Kapolres Bima seharusnya menjadi jembatan bagi penyelesaian yang adil dan damai, bukan justru menjadi penghalang dalam proses hukum yang menjunjung tinggi kemanusiaan," kata Ketua DPD IMM.</p>
            <p>Senada, Ketua PW KAMMI NTB Iwan Julkarnain, kehadiran kami bukan hanya retorika belaka, melainkan ini adalah ultimatum serius terhadap proses penegakan hukum di wilayah NTB.</p>
            <p>"Kami menduga bahwa Kapolres Bima dan Kapolda NTB salah satu upaya untuk membungkam gerakan-gerakan dan kami akan mengintruksikan kepada seluruh daerah agar melakukan gerakan serentak untuk menuntut bebaskan 6 aktivis yang di tahan di Polda ini," kecam Iwan Julkarnain.</p>
            <p>Ketua DPD GMNI NTB Al Mukmin Betika mendesak Kapolri, Komnas HAM, Kompolnas serta lembaga-lembaga pengawas lainnya untuk turun tangan dan mengevaluasi sikap Polres Bima yang dianggap kontraproduktif terhadap penyelesaian konflik secara damai dan beradab, serta mengabaikan Surat Edaran Kapolri.</p>
            <p>"Berdasarkan surat Kapolri, Nomor SE/2/II/2021 yang menegaskan pentingnya pendekatan Restorative Justice dalam penanganan perkara-perkara tertentu, terutama yang tidak menimbulkan korban jiwa atau berpotensi menciptakan konflik sosial berkepanjangan," desakan Al Mukmin Betika.</p>
            <p>CIPAYUNG PLUS PROVINSI NTB MENYATAKAN SIKAP:</p>
            <ol class="list-decimal list-inside space-y-2">
                <li>MENDESAK KEPOLISIAN REPUBLIK INDONESIA BAPAK JENDERAL LISTYO SIGIT PRABOWO UNTUK MENCOPOT KAPOLRES KABUPATEN BIMA AKB EKO SUTOMO BIMA ATAS PENOLAKAN RESTORATIVE JUSTICE.</li>
                <li>MEMINTA KEPADA KAPOLRI BAPAK JENDERAL LISTYO SIGIT PRABOWO UNTUK MEMBEBASKAN KE-ENAM MAHASISWA YANG DI TAHAN DI POLDA NTB TANPA SYARAT.</li>
                <li>MEMINTA KEPADA KAPOLRI BAPAK JENDERAL LISTYO SIGIT PRABOWO UNTUK MENGEVALUASI KAPOLDA NTB IRJEN. POL. HADI GUNAWAN, SH., S.I.K KARENA GAGAL MEMBERIKAN EDUKASI PELAYANAN KAMTIBMAS PRESISI.</li>
                <li>MENYERUKAN PENERAPAN PRINSIP KEADILAN RESTORATIF DALAM SETIAP PENYELESAIAN KONFLIK SOSIAL YANG TIDAK MENGANDUNG UNSUR KEKERASAN BERAT.</li>
            </ol>
        `
    },
    {
